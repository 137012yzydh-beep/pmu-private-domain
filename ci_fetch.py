...
# ═══════════════════════════════════════════
# 生成 HTML（v6：三栏布局 + 绿点睡眠 + 黄点饮食 + localStorage）
# ═══════════════════════════════════════════
...
<div class="modal-overlay" id="sleepModal">
  <div class="modal slp-modal">
    <button class="modal-close" onclick="closeSleep()">✕</button>
    <h2>😴 睡眠记录</h2>
...
<p style="color:#555;font-size:12px;margin-top:16px;text-align:center;">
  数据来自训记 API · 绿点管理睡眠 · 黄点管理饮食 · 由 GitHub Actions 每日自动更新
</p>
</body>
</html>
"""
